...
Page({
  ...
  btns1:function (event){
    ...
    let aid = event.currentTarget.id;
    console.log(aid)
    var ul = "http://localhost:8080/activities/delete?aid=" + aid + "&uid= "+ that.data.userInfo.data.id;
    console.log(ul)
    wx.request({
      url: ul,
      data:{
  ...
  onLoad: function () {
    ...
    var ul = "http://localhost:8080/activities/my/" + that.data.userInfo.data.id;
    console.log(ul)
    wx.request({
      url: ul,
      data:{
